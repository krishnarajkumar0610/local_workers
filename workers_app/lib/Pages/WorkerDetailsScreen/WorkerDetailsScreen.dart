...
import 'package:workers_app/Pages/WorkerAppointedScreen/WorkerAppointedScreen.dart';
...
class _WorkerDetailsScreenState extends State<WorkerDetailsScreen> {
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      context.read<WorkerScreenProvider>().setWorker(widget.worker);
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(child: SingleChildScrollView(
        child:
            Consumer<WorkerScreenProvider>(builder: (context, provider, child) {
          return Padding(
                ...
                return Column(
                  children: [
                      ...
                      child: Stack(
                        ...
                        children: [
                          Container(
                            ...
                            child: provider
                                    .currentWorker!.profile.profileImg.isEmpty
                                ? ClipOval(
                                    child: Image.asset(
                    ...
                    Container(
                      ...
                      child: Text(provider.currentWorker!.profile.jobTitle),
                    ),
                    SizedBox(
                      height: 15.h(context),
                    ),
                    ...
                    Container(
                      ...
                      child: SingleChildScrollView(
                          child: Text(
                              provider.currentWorker!.profile.description)),
                    ),
                    SizedBox(
                      height: 30.h(context),
                    ),
                    Consumer<HomeScreenProvider>(
                      ...
                      return InkWell(
                        ...
                        onTap: () async {
                          await homeScreenProvider.hireWorker(
                              client: homeScreenProvider.user,
                              worker: provider.currentWorker!);

                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                builder: (context) => WorkerAppointedScreen(),
                              ));
